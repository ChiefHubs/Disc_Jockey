...
export default function ForceSignUpInPage({ view = "artist" }: propForceSignUpInPage) {
    ...
    <Flex>
      <VStack w="100%">
        <VStack pt="20px" pb="25px">
          ...
          <Heading fontSize="1.1em" borderRadius="5px" fontWeight="600" style={{ padding: "12px" }}>
            OR
          </Heading>
          ...
          {view == "artist" && (
            <>
              <Heading fontSize="1.3em" fontWeight="400" style={{ paddingTop: "30px", paddingBottom: "12px" }}>
                Get access to my
              </Heading>
